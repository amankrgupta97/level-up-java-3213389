...
public class App 
{
    public static void redactTextFile(String fileName,String[] redactedWordsArray) {
        ...
        try{
            ...
            BufferedWriter redactedBufferedWriter = new BufferedWriter(new FileWriter(redactedFile));
            ...
            while(currentLine!=null){
                ...
                redactedBufferedWriter.append(currentLine).append("\n");
                currentLine=originalFileReader.readLine();
            }
            originalFileReader.close();
            redactedBufferedWriter.close();
        }catch(IOException e){
            System.out.println("Problem in reading and writing file"+e);
        }
    }
